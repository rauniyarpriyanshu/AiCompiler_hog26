...
public class CodeEditorJava {
    ...
    public VirtualizedScrollPane<CodeArea> getCode() {
...
*/
    ...
    //    codeArea.setPrefHeight(600);
        VirtualizedScrollPane<CodeArea> area = new VirtualizedScrollPane<>(codeArea);
        area.getStylesheets().add(CodeEditorJava.class.getResource("/css/java-keyword.css").toExternalForm());
        area.setPrefHeight(500);
        area.setPrefWidth(880);
        area.setMaxHeight(600);
        //area.setMaxWidth(1900);
        return area;
    }
